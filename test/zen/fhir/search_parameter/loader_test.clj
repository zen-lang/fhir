...
(def observation-combo-code
  {:zen.fhir/package-ns 'fhir-r5
   :type "code"})

(def observation-combo-value-quantity
  {:zen.fhir/package-ns 'fhir-r5
   :type "quantity"})
...
(def ztx
  (atom {:fhir/inter {"StructureDefinition" structure-definition-ir-fixture
                      ...
                      {"http://hl7.org/fhir/SearchParameter/individual-given" loaded-sp
                       "http://hl7.org/fhir/SearchParameter/Observation-combo-code" observation-combo-code
                       "http://hl7.org/fhir/SearchParameter/Observation-combo-value-quantity" observation-combo-value-quantity
...
(t/deftest process-composite-search-parameter-test
  (matcho/match (sut/process-search-parameter ztx loaded-composite-sp)
                {:zen.fhir/package-ns 'fhir-r5,
                 :multipleOr false,
                 :name "combo-code-value-quantity",
                 :type "composite",
