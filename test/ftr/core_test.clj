...
(def test-env-cfg {:csv-source "/tmp/ftr-fixtures/cfg.csv"
                   :ftr-path "/tmp/ftr"
                   :expected-tf-sha256 "674ecaffd516c78938551d5a1d20cc6735f46be82fe45e94b8cf6d3ab8612145"
                   :expected-tf-filename "tf.674ecaffd516c78938551d5a1d20cc6735f46be82fe45e94b8cf6d3ab8612145.ndjson.gz"})


(defn prepare-test-env! [{:as _cfg, :keys [csv-source]}]
